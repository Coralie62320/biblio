...
class LivreManager extends ConnexionManager
{
    ...
    public function getAllLivres()
    {
        ...
        $this->livres = [];
        foreach ($livresImportes as $livre) {
            $nouveauLivre = new Livre($livre['id_livre'], $livre['image'], $livre['titre'], $livre['nb_pages'], $livre['identifiant'] != null ? $livre['identifiant'] : "Pas d'uploader");
            $this->ajouterLivre($nouveauLivre);
        }
        return $this->livres;
    }
    ...
    public function ajouterLivreBdd($titre, $nbPages, $nomImage, $id_user)
    {
